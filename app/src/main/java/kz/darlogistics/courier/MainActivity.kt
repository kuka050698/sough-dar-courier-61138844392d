...
class MainActivity : AppCompatActivity(), AuthContract.LoginView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            presenter.loginUser("326DA02@mail.ru", "1")
    ...
    override fun onDestroy() {
        super.onDestroy()
        if (isFinishing) {
            Logger.msg("Activity finish")
        } else {
            Logger.msg("Activity rotate")
        }
    }
